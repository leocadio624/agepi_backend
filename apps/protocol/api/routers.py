...
from apps.protocol.api.views.catt_protocolos_views import ( ProtocolCattStartViewSet, filtrarProtocolosViewSet, asignacionProtocoloViewSet, getFechaAsignacionViewSet, 
					getProfesoresSeleccionViewSet, getFechaEvaluacionViewSet, generarDictamenViewSet, getFechaDictamenViewSet, verDictamenViewSet, asignacionAcademiasViewSet,
					validarProtocoloViewSet ,selectProtocolViewSet, existeEvalucacionViewSet, generarEvalucacionViewSet)
...
router.register(r'validarProtocolo', validarProtocoloViewSet, basename = 'validarProtocolo')
